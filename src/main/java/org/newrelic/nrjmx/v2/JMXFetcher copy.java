...
public class JMXFetcher {
    ...
    public List<JMXAttribute> queryMbean(String beanName) throws JMXError {
        ...
        try {
            ...
            // JMXAttribute a1 = new JMXAttribute();
            // a1.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=authenticationRetries";
            // a1.valueType = ValueType.INT;
            // a1.intValue = 3;
            // result.add(a1);

            // JMXAttribute a2 = new JMXAttribute();
            // a2.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=heartbeatInterval";
            // a2.valueType = ValueType.INT;
            // a2.intValue = 6000;
            // result.add(a2);

            // JMXAttribute a3 = new JMXAttribute();
            // a3.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=maxInboundChannels";
            // a3.valueType = ValueType.INT;
            // a3.intValue = 40;
            // result.add(a3);

            // JMXAttribute a4 = new JMXAttribute();
            // a4.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=maxInboundMessageSize";
            // a4.valueType = ValueType.INT;
            // a4.intValue = Long.parseLong("9223372036854775807");
            // result.add(a4);

            // JMXAttribute a5 = new JMXAttribute();
            // a5.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=maxInboundMessages";
            // a5.valueType = ValueType.INT;
            // a5.intValue = 80;
            // result.add(a5);

            // JMXAttribute a6 = new JMXAttribute();
            // a6.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=maxOutboundChannels";
            // a6.valueType = ValueType.INT;
            // a6.intValue = 80;
            // result.add(a6);

            // JMXAttribute a7 = new JMXAttribute();
            // a7.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=maxOutboundMessageSize";
            // a7.valueType = ValueType.INT;
            // a7.intValue = Long.parseLong("9223372036854775807");
            // result.add(a7);

            // JMXAttribute a8 = new JMXAttribute();
            // a8.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=maxOutboundMessages";
            // a8.valueType = ValueType.INT;
            // a8.intValue = 65535;
            // result.add(a8);
            
            // JMXAttribute a9 = new JMXAttribute();
            // a9.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=receiveBufferSize";
            // a9.valueType = ValueType.INT;
            // a9.intValue = 8192;
            // result.add(a9);

            // JMXAttribute a10 = new JMXAttribute();
            // a10.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=receiveWindowSize";
            // a10.valueType = ValueType.INT;
            // a10.intValue = 131072;
            // result.add(a10);

            // JMXAttribute a11 = new JMXAttribute();
            // a11.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=saslProtocol";
            // a11.valueType = ValueType.STRING;
            // a11.stringValue = "remote";
            // result.add(a11);

            // JMXAttribute a12 = new JMXAttribute();
            // a12.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=sendBufferSize";
            // a12.valueType = ValueType.INT;
            // a12.intValue = 8192;
            // result.add(a12);

            // JMXAttribute a13 = new JMXAttribute();
            // a13.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=transmitWindowSize";
            // a13.valueType = ValueType.INT;
            // a13.intValue = 131072;
            // result.add(a13);

            // JMXAttribute a14 = new JMXAttribute();
            // a14.attribute = "jboss.as:subsystem=remoting,configuration=endpoint,attr=worker";
            // a14.valueType = ValueType.STRING;
            // a14.stringValue = "default";
            // result.add(a14);
    ...
    public Map<String, String> queryMbean2(String beanName) throws JMXError {
        ...
        try {
            ...
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=authenticationRetries", "3");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=heartbeatInterval", "6000");
    
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=maxInboundChannels", "40");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=maxInboundMessageSize", "9223372036854775807");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=maxInboundMessages", "80");
    
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=maxOutboundChannels", "80");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=maxOutboundMessageSize", "9223372036854775807");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=maxOutboundMessages", "65535");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=receiveBufferSize", "8192");
    
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=receiveWindowSize", "131072");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=saslProtocol", "remote");
    
    
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=sendBufferSize", "8192");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=transmitWindowSize", "131072");
            results.put("jboss.as:subsystem=remoting,configuration=endpoint,attr=worker", "default");
