...
public class JMXConfig implements org.apache.thrift.TBase<JMXConfig, JMXConfig._Fields>, java.io.Serializable, Cloneable, Comparable<JMXConfig> {
  ...
  private static final org.apache.thrift.protocol.TField CONN_URL_FIELD_DESC = new org.apache.thrift.protocol.TField("connURL", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String connURL; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.CONN_URL, new org.apache.thrift.meta_data.FieldMetaData("connURL", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public JMXConfig(JMXConfig other) {
    ...
    if (other.isSetConnURL()) {
      this.connURL = other.connURL;
    }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getConnURL() {
    return this.connURL;
  }

  public JMXConfig setConnURL(@org.apache.thrift.annotation.Nullable java.lang.String connURL) {
    this.connURL = connURL;
    return this;
  }

  public void unsetConnURL() {
    this.connURL = null;
  }

  /** Returns true if field connURL is set (has been assigned a value) and false otherwise */
  public boolean isSetConnURL() {
    return this.connURL != null;
  }

  public void setConnURLIsSet(boolean value) {
    if (!value) {
      this.connURL = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CONN_URL:
      if (value == null) {
        ...
        setConnURL((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(JMXConfig that) {
    ...
    boolean this_present_connURL = true && this.isSetConnURL();
    boolean that_present_connURL = true && that.isSetConnURL();
    if (this_present_connURL || that_present_connURL) {
      if (!(this_present_connURL && that_present_connURL))
        return false;
      if (!this.connURL.equals(that.connURL))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetConnURL()) ? 131071 : 524287);
    if (isSetConnURL())
      hashCode = hashCode * 8191 + connURL.hashCode();
  ...
  public int compareTo(JMXConfig other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetConnURL(), other.isSetConnURL());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetConnURL()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.connURL, other.connURL);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class JMXConfigStandardScheme extends org.apache.thrift.scheme.StandardScheme<JMXConfig> {
        ...
        switch (schemeField.id) {
          case 1: // CONN_URL
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.connURL = iprot.readString();
              struct.setConnURLIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JMXConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.connURL != null) {
        oprot.writeFieldBegin(CONN_URL_FIELD_DESC);
        oprot.writeString(struct.connURL);
        oprot.writeFieldEnd();
      }
