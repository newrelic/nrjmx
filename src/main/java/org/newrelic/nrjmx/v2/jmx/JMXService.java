...
public class JMXService {
  ...
  public interface Iface {
    ...
    public java.util.List<JMXLoggerMessage> getLogs() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getLogs(org.apache.thrift.async.AsyncMethodCallback<java.util.List<JMXLoggerMessage>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.util.List<JMXLoggerMessage> recv_getLogs() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getLogs_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<JMXLoggerMessage>> {
      public getLogs_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<JMXLoggerMessage>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<JMXLoggerMessage> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getLogs<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getLogs_args, java.util.List<JMXLoggerMessage>> {
      public getLogs() {
        super("getLogs");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<JMXLoggerMessage>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<JMXLoggerMessage>>() { 
          public void onComplete(java.util.List<JMXLoggerMessage> o) {
            getLogs_result result = new getLogs_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getLogs_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<JMXLoggerMessage>> resultHandler) throws org.apache.thrift.TException {
...
;
  ...
  public static class queryMbean_args implements org.apache.thrift.TBase<queryMbean_args, queryMbean_args._Fields>, java.io.Serializable, Cloneable, Comparable<queryMbean_args>   {
    ...
    public int compareTo(queryMbean_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetBeanName(), other.isSetBeanName());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetBeanName()) {
...
;
  ...
  public static class getLogs_result implements org.apache.thrift.TBase<getLogs_result, getLogs_result._Fields>, java.io.Serializable, Cloneable, Comparable<getLogs_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<JMXLoggerMessage> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, JMXLoggerMessage.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public getLogs_result(
      java.util.List<JMXLoggerMessage> success)
    {
      this();
      this.success = success;
    }
    ...
    public getLogs_result(getLogs_result other) {
      if (other.isSetSuccess()) {
        java.util.List<JMXLoggerMessage> __this__success = new java.util.ArrayList<JMXLoggerMessage>(other.success.size());
        for (JMXLoggerMessage other_element : other.success) {
          __this__success.add(new JMXLoggerMessage(other_element));
        }
        this.success = __this__success;
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<JMXLoggerMessage> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(JMXLoggerMessage elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<JMXLoggerMessage>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<JMXLoggerMessage> getSuccess() {
      return this.success;
    }

    public getLogs_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<JMXLoggerMessage> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<JMXLoggerMessage>)value);
        }
        break;
    ...
    private static class getLogs_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getLogs_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<JMXLoggerMessage>(_list8.size);
                  @org.apache.thrift.annotation.Nullable JMXLoggerMessage _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = new JMXLoggerMessage();
                    _elem9.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getLogs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (JMXLoggerMessage _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getLogs_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getLogs_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getLogs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (JMXLoggerMessage _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<JMXLoggerMessage>(_list13.size);
            @org.apache.thrift.annotation.Nullable JMXLoggerMessage _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = new JMXLoggerMessage();
              _elem14.read(iprot);
